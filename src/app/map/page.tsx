...
export default function MapPage() {
  ...
  return (
    <div className={`flex min-h-screen flex-col items-center bg-gradient-to-b ${theme.background} p-6`}>
      <h1 className="mt-2 text-2xl font-black text-white">Jungle Map</h1>
      <p className="text-sm text-lime-200">Choose a path to explore</p>
            ...
            <button
              ...
              className={`w-full rounded-2xl px-5 py-3 text-left shadow-lg transition-transform ${
                isCurrent
                  ...
                  : isUnlocked
                    ? "bg-emerald-900/80 hover:scale-105"
