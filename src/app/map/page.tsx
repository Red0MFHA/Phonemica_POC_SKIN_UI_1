  ...
  return (
    <div className={`relative flex min-h-screen flex-col items-center overflow-hidden bg-gradient-to-b ${theme.background} p-6`}>
      ...
      <div className="relative z-10 flex w-full max-w-xs flex-col items-center">
        <h1 className="mt-2 text-3xl font-black text-white drop-shadow">Jungle Map 🌴</h1>
        <p className="mt-1 text-base text-lime-200">Choose a path to explore</p>
            ...
            return (
              <button
                ...
                className={`w-full rounded-2xl px-6 py-4 text-left shadow-lg transition-transform ${
                  isCurrent
                    ? "scale-105 border-2 border-amber-400 bg-emerald-800"
                    : isUnlocked
                      ? "bg-emerald-900/80 hover:scale-105 active:scale-95"
                      : "bg-emerald-950/50 opacity-60"
                }`}
              >
